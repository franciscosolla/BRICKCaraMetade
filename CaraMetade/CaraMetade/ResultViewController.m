...
- (void)viewDidLoad {
	...
	CGImageRef leftImage = CGImageCreateWithImageInRect(self.face.CGImage, CGRectMake(0, 0, self.face.size.height, (self.face.size.width * ( 1.0 -[self.sliderStatus doubleValue]))));
	CGImageRef rightImage = CGImageCreateWithImageInRect(self.face.CGImage, CGRectMake(0, (self.face.size.width * (1.0-[self.sliderStatus doubleValue])), self.face.size.height, (self.face.size.width * [self.sliderStatus doubleValue])));
